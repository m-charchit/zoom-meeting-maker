...
Topic: {result["topic"]}
Time: {(datetime.strptime(result["start_time"],"%Y-%m-%dT%H:%M:%SZ").strftime("%I:%M %p, %d %b %G"))}
...
def getMessage():
    ...
    a = createMeeting(startTime + "T08:30:00Z", "10")
    b = createMeeting(startTime + "T09:30:00Z", "9")
    return a, b
